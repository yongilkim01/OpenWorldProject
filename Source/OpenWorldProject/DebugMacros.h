...
#define DRAW_SPHERE(Loaction) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 25.f, 12, FColor::Green, true);
#define DRAW_SPHERE_COLOR(Loaction, Color) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 8.f, 12, Color, false, 5.f);
